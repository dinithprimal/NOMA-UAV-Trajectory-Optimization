...
plot(steps,h_UAV_BS_dB(:,1,1),'k--o','linewidth', 1);hold on;
plot(steps,h_UAV_BS_dB(:,1,2),'k--*','linewidth', 1);
plot(steps,h_UAV_BS_dB(:,1,3),'k--x','linewidth', 1);

title('Rician Channel Power between UAV and BSs in each Step')
xlabel('Steps')
ylabel('Channel power in dB')
xlim([1 21])
%ylim([0 1])
...
figure;
plot(steps,achievableRate_ch(:,1),'c--^','linewidth', 1);hold on;
plot(steps,achievableRate_ch(:,2),'c--square','linewidth', 1);
plot(steps,achievableRate_ch(:,3),'c--diamond','linewidth', 1);

plot(steps,achievableRate_ch_Up(:,1),'y-^','linewidth', 1);hold on;
plot(steps,achievableRate_ch_Up(:,2),'y-square','linewidth', 1);
plot(steps,achievableRate_ch_Up(:,3),'y-diamond','linewidth', 1);
...
figure;
plot(steps,achievableRate_BS(:,1),'c--o','linewidth', 1);hold on;
plot(steps,achievableRate_BS(:,2),'c--*','linewidth', 1);
plot(steps,achievableRate_BS(:,3),'c--x','linewidth', 1);

plot(steps,achievableRate_BS_Up(:,1),'y-o','linewidth', 1);hold on;
plot(steps,achievableRate_BS_Up(:,2),'y-*','linewidth', 1);
plot(steps,achievableRate_BS_Up(:,3),'y-x','linewidth', 1);

title('Achievable Rate for BSs in each Step (With Channel based Power Coefficeints)')
xlim([1 21])
%ylim([0 1])
legend('BS 1', 'BS 2', 'BS 3','BS 1 (Optimized)', 'BS 2 (Optimized)', 'BS 3 (Optimized)');
grid on;
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure;
plot(steps,achievableRate_ch_SWIPT(:,1),'c--^','linewidth', 1);hold on;
plot(steps,achievableRate_ch_SWIPT(:,2),'c--square','linewidth', 1);
plot(steps,achievableRate_ch_SWIPT(:,3),'c--diamond','linewidth', 1);

plot(steps,achievableRate_ch_SWIPT_Up(:,1),'y-^','linewidth', 1);hold on;
plot(steps,achievableRate_ch_SWIPT_Up(:,2),'y-square','linewidth', 1);
plot(steps,achievableRate_ch_SWIPT_Up(:,3),'y-diamond','linewidth', 1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure;
plot(steps,minAchRate(:),'g--<','linewidth', 1);hold on;

plot(steps,minAchRate_Up(:),'m-<','linewidth', 1);
...
figure;
plot(steps,minAchRate_SWIPT(:),'g-->','linewidth', 1);hold on;

plot(steps,minAchRate_Up_SWIPT(:),'m->','linewidth', 1);

title('Minimum Achievable Rate of Network in each Step in SWIPT Model (With Channel based based Power Coefficeints)')
xlim([1 21])
%ylim([0 1])
xlabel('Steps')
ylabel('Achievable Rate in bps')
