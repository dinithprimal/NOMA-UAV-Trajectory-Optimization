function updatedPosition = positionUpdate_PSO_SWIPT(xUAV,yUAV,zUAV,xBS,yBS,zBS,minRat,noUsers,xUser,yUser,g,noBS)
    ...
    for i = 1:nPop
        ...
        [minZ, x(i).fitness] = objective_function_positionUpdate_3D_SWIPT(x(i).position,...
            xUAV,yUAV,zUAV,zBS,yBS,zBS,noUsers,xUser,yUser,minRate,g,noBS);
